class Users::OmniauthCallbacksController < Devise::OmniauthCallbacksController
  ...
  #         set those key/value pairs in the MyGists session. Next, we sign
  #         the user in and redirect it. Flash messages are set for successful
  #         sign in and that the request came from this callback.
